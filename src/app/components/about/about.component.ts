...
export class AboutComponent {
  ...
  keyWork=[
    'Developed and maintained scalable and secure web applications using Angular and Spring Boot.',
    'Developed RESTful APIs with JWT Authentication for secure data access.',
